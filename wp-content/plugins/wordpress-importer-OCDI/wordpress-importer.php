<?php
/*
Plugin Name: WordPress Importer ( edited version )
Plugin URI: http://wordpress.org/extend/plugins/wordpress-importer/
Description: An edited version of WordPress Importer Plugin designed for the one click demo install feature on themes by Dahz. if you want to use the default WordPress Importer plugin you will need to delete this version first. 
