<div class="df-to-content-inner">
    <div class="df-col-1 df-to-section">
        <div class="df-col-5 df-no-padding">
            <div class="field">
                <h4>Header Style</h4>
                <span class="description">Choose the style for your header, this option will change the header style for Search pages</span>
            </div>
        </div>
        <div class="df-col-2">
            <?php
    			DF_Element_Generator::df_html_select(array(
    				'name' => array( 'template_setting', 'search_template','header_layout' ),
    ...
    <div class="df-col-1 df-to-section">
        <div class="df-col-5 df-no-padding">
            <div class="field">
                ...
                <span class="description">Choose the Article Display Layout for Search page</span>
            </div>
        </div>
        <div class="df-col-2">
            <?php
                DF_Element_Generator::df_html_visual_select(array(
                    'name' => array( 'template_setting', 'search_template','article_display_preview' ),
                    'class'=>'df-to-styled-select',
                    'options' => array(
                        array(
    ...
    <div class="df-col-1 df-to-section">
        <div class="df-col-5 df-no-padding">
            <div class="field">
                <h4>Layout</h4>
                <span class="description">Choose the layout style for Search pages</span>
            </div>
        </div>
        <div class="df-col-2">
            <?php
                DF_Element_Generator::df_html_visual_select(array(
                    'name' => array( 'template_setting', 'search_template','layout' ),
                    'class'=>'df-to-styled-select',
                    'options' => array(
                        array(
    ...
    <div class="df-col-1 df-to-section">
        <div class="df-col-5 df-no-padding">
            <div class="field">
                ...
                <span class="description">Choose which sidebar widget that you want to use for Search pages</span>
            </div>
        </div>
        <div class="df-col-2">
            <?php
                DF_Element_Generator::df_html_select(array(
                    'name' => array( 'template_setting', 'search_template', 'sidebar_widget' ),
                    'class' => 'df-to-styled-select',
	...
	<div class="df-col-1 df-to-section">
		...
		<div class="df-col-2">
			<?php
				DF_Element_Generator::df_html_select(array(
					'name' => array('template_setting','search_template','pagination'),
					'class'=>'df-to-styled-select',
					'options' => array(
						array(
