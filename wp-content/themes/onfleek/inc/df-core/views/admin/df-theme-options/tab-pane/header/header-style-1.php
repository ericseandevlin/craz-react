<div class="df-to-content-inner">
        ...
        <div class="df-col-2">
            <?php
				DF_Element_Generator::df_html_select(array(
					'name' => array('header','header_style_1','header_layout'),
        ...
        <div class="df-col-2">
            <?php
				 DF_Element_Generator::df_html_slider_bar(array(
 					'name'=>array('header','header_style_1','header_logo_top_padding')
 				));
			?>
        </div>
    </div>
    <div class="df-col-1 df-to-section">   
        ...
        <div class="df-col-2">
            <?php
				DF_Element_Generator::df_html_slider_bar(array(
					'name'=>array('header','header_style_1','header_logo_bottom_padding'),
				));
			?>
        </div>
    </div>
    <div class="df-col-1 df-to-section">
        ...
        <div class="df-col-2">
            <div>
            	<?php
					DF_Element_Generator::df_html_color_picker(array(
						'name'=>array('header','header_style_1','header_logo_bg','bg_color'),
			...
			<?php
				DF_Element_Generator::df_html_select(array(
					'name' => array('header','header_style_1','header_logo_bg','bg_position'),
			...
			<?php
				DF_Element_Generator::df_html_select(array(
					'name' => array('header','header_style_1','header_logo_bg','bg_repeat'),
			...
			<?php
				DF_Element_Generator::df_html_select(array(
					'name' => array('header','header_style_1','header_logo_bg','bg_attachment'),
			...
			<?php
				DF_Element_Generator::df_html_select(array(
					'name' => array('header','header_style_1','header_logo_bg','bg_size'),
			...
			<?php
				DF_Element_Generator::df_html_uploader(array(
					'name'=>array('header','header_style_1','header_logo_bg','bg'),
				));
			?>
		</div>
	</div>
    <div class="df-col-1 df-to-section">
        ...
        <div class="df-col-2">
            <?php
				DF_Element_Generator::df_html_color_picker(array(
					'name'	=>array('header','header_style_1','nav_bg_color'),
        ...
        <div class="df-col-2">
			<?php
				DF_Element_Generator::df_html_numeric(array(
								'name'=>array('header','header_style_1','top_border','border'),
								'class'=>'df-input-styled'
							));
			?>
			<?php
				DF_Element_Generator::df_html_select(array(
				'name' => array('header','header_style_1','top_border','style'),
				'class'=>'df-to-styled-select',
			...
			<?php
				DF_Element_Generator::df_html_color_picker(array(
					'name'		=>array('header','header_style_1','top_border','color'),
    ...
    <div class="df-col-1 df-to-section">
        ...
        <div class="df-col-2">
			<?php
				DF_Element_Generator::df_html_numeric(array(
					'name'=>array('header','header_style_1','bottom_border','border'),
					'class'=>'df-input-styled'
				));
			?>
			<?php
				DF_Element_Generator::df_html_select(array(
				'name' => array('header', 'header_style_1','bottom_border','style'),
				'options' => DF_Theme_Options::$css_border_style,
				'class'=>'df-to-styled-select'
			));
			?>
			<?php
				DF_Element_Generator::df_html_color_picker(array(
					'name'	=>array('header','header_style_1','bottom_border','color'),
    ...
    <div class="df-col-1 df-to-section">
        ...
        <div class="df-col-2">
			<?php
				DF_Element_Generator::df_html_color_picker(array(
					'name'=>array('header','header_style_1','nav_text_color','regular_color'),
					'label' => 'Regular Color'
				));
			?>
			<div>
				<?php
					DF_Element_Generator::df_html_color_picker(array(
						'name'	=> array('header','header_style_1','nav_text_color','hover_color'),
						'label'	=> 'Hover Color'
					));
				?>
			</div>
        ...
        <div class="df-col-2">
            <?php
				DF_Element_Generator::df_html_switch(array(
					'name'=>array('header','header_style_1','search')
				));
			?>
        </div>
    </div>
...
<div id="header-style-1-detail">
   	<div class="df-to-content-inner">
            ...
            <?php
				DF_Element_Generator::df_html_switch(array(
					'name'=>array('header','header_style_1','social_icon_topbar')
				));
			?>
            </div>
        </div>
        <div class="df-col-1 df-to-section">
            ...
            <div class="df-col-2">
				<?php
					DF_Element_Generator::df_html_color_picker(array(
						'name' 	=> array('header','header_style_1','topbar_bg_color'),
						'label' => 'Topbar Color'
					));
				?>									
            </div>
        ...
        <div class="df-col-1 df-to-section">
            ...
            <div class="df-col-2">
					<?php
						DF_Element_Generator::df_html_numeric(array(
							'name'=>array('header','header_style_1','topbar_bottom_border','border'),
							'class' => 'df-input-styled'
						));
					?>
					<?php
						DF_Element_Generator::df_html_select(array(
						'name' => array('header','header_style_1','topbar_bottom_border','style'),
						'options' => DF_Theme_Options::$css_border_style,
						'class' => 'df-to-styled-select'
					));
					?>
					<?php
						DF_Element_Generator::df_html_color_picker(array(
							'name'	=>array('header','header_style_1','topbar_bottom_border','color'),
							'label' => 'Bottom Border Color'
						));
					?>
            </div>
        ...
        <div class="df-col-1 df-to-section">
            ...
            <div class="df-col-2">
				<?php
					DF_Element_Generator::df_html_color_picker(array(
						'name' 	=> array('header','header_style_1','topbar_text_color','regular_color'),
						'label' => 'Regular Color'
					));
				?>
				<div>
				<?php
					DF_Element_Generator::df_html_color_picker(array(
						'name'	=>array('header','header_style_1','topbar_text_color','hover_color'),
						'label' => 'Hover Color'
					));
				?>	
				</div>									
