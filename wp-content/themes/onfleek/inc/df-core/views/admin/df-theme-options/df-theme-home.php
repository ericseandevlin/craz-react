...
<body>
	<div class="wrap about-wrap">
		...
		?>
			...
			<a href="<?php echo admin_url("admin.php?page=df_theme_support"); ?>" class="nav-tab nav-tab-active"><?php _e( 'Support','onfleek' ); ?></a>   
	   </h2>
	   		<div class="df-theme">
				<div class="df-col-4">
					...
					<?php printf( '<a href="%s" class="button button-large button-primary" target="_blank">%s</a>','http://dahz.daffyhazan.com/onfleek/docs', __( 'Documentation', "onfleek" ) ); ?>
				</div>
				<div class="df-col-4">
					...
					<?php printf( '<a href="%s" class="button button-large button-primary" target="_blank">%s</a>', 'http://support.daffyhazan.com/', __( 'Community Forum', "onfleek" ) ); ?>
				</div>            
