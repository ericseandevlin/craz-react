<div class="df-to-content-inner">
        ...
        <div class="df-col-2">
            <?php
                DF_Element_Generator::df_html_select(array(
                    'name' => array('header','header_style_5','header_layout'),
        ...
        <div class="df-col-2">
            <?php
                DF_Element_Generator::df_html_slider_bar(array(
                    'name'=>array('header','header_style_5','header_logo_top_padding')
                ));
            ?>
        </div>
    </div>
    ...
    <div class="df-col-1 df-to-section">
        ...
        <div class="df-col-2">
            <?php
                DF_Element_Generator::df_html_slider_bar(array(
                    'name'=>array('header','header_style_5','header_logo_bottom_padding')
                ));
            ?>
        </div>
    </div>
        ...
        <div class="df-col-2">
            <?php
                DF_Element_Generator::df_html_color_picker(array(
                    'name'=>array('header','header_style_5','nav_text_color_light','regular_color')
                ),'Regular Color');
            ?>
            <div>
                <?php
                    DF_Element_Generator::df_html_color_picker(array(
                        'name'=>array('header','header_style_5','nav_text_color_light','hover_color')
                    ),'Hover Color');
                ?>
            </div>
        </div>                                      
    ...
    <div class="df-col-1 df-to-section">
        ...
        <div class="df-col-2">
            <?php
                DF_Element_Generator::df_html_color_picker(array(
                        'name'=>array('header','header_style_5','nav_text_color_dark','regular_color')
                    ),'Regular Color');
            ?>
            <div>
            <?php
                DF_Element_Generator::df_html_color_picker(array(
                    'name'=>array('header','header_style_5','nav_text_color_dark','hover_color')
                ),'Hover Color');
            ?> 
            </div>                                        
        </div>
    ...
    <div class="df-col-1 df-to-section">
        ...
        <?php
            DF_Element_Generator::df_html_switch(array(
                'name'=>array('header','header_style_5','search')
            ));
        ?>
        </div>
    </div>
    ...
    <div class="df-to-content-inner">
        <div class="df-col-1 df-to-section">
            ...
            <div class="df-col-2">
                <?php
                    DF_Element_Generator::df_html_switch(array(
                        'name'=>array('header','header_style_5','social_icon_topbar')
                    ));
                ?>
            </div>
        </div>
        <div class="df-col-1 df-to-section">
            ...
            <div class="df-col-2">
                <?php
                    DF_Element_Generator::df_html_color_picker(array(
                        'name'=>array('header','header_style_5','topbar_text_color_light','regular_color')
                    ),'Regular Color');
                ?>
                <div>
                <?php
                    DF_Element_Generator::df_html_color_picker(array(
                        'name'=>array('header','header_style_5','topbar_text_color_light','hover_color')
                    ),'Hover Color');
                ?>
                </div>
            </div>                                      
            ...
            <div class="df-col-2">
                <?php
                    DF_Element_Generator::df_html_numeric(array(
                        'name'=>array('header','header_style_5','topbar_bottom_border_light','border'),
                        'class' => 'df-input-styled'
                    ));
                ?>
                <?php
                    DF_Element_Generator::df_html_select(array(
                        'name' => array('header','header_style_5','topbar_bottom_border_light','style'),
                        'class' => 'df-to-styled-select',
                ...
                <?php
                    DF_Element_Generator::df_html_color_picker(array(
                        'name'=>array('header','header_style_5','topbar_bottom_border_light','color'),
                    ),'Bottom Border Color');
                ?>
                <?php
                    DF_Element_Generator::df_html_slider_bar(array(
                        'name'=>array('header','header_style_5','topbar_bottom_border_light','opacity')
                    ));
                ?>
            </div>
        </div>
        <div class="df-col-1 df-to-section">
            ...
            <div class="df-col-2">
                <?php
                    DF_Element_Generator::df_html_color_picker(array(
                        'name'=>array('header','header_style_5','topbar_text_color_dark','regular_color')
                    ),'Regular Color');
                ?>
                <div>
                    <?php
                        DF_Element_Generator::df_html_color_picker(array(
                            'name'=>array('header','header_style_5','topbar_text_color_dark','hover_color')
                        ),'Hover Color');
                    ?> 
                </div>                                        
            </div>
        ...
        <div class="df-col-1 df-to-section">
            ...
            <div class="df-col-2">
                <?php
                    DF_Element_Generator::df_html_numeric(array(
                        'name'=>array('header','header_style_5','topbar_bottom_border_dark','border'),
                        'class' => 'df-input-styled'
                    ));
                ?>
                <?php
                    DF_Element_Generator::df_html_select(array(
                        'name' => array('header','header_style_5','topbar_bottom_border_dark','style'),
                        'class' => 'df-to-styled-select',
                        'options' => DF_Theme_Options::$css_border_style
                    ));
                ?>
                <?php
                    DF_Element_Generator::df_html_color_picker(array(
                        'name'=>array('header','header_style_5','topbar_bottom_border_dark','color'),
                    ),'Bottom Border Color');
                ?>
                <?php
                    DF_Element_Generator::df_html_slider_bar(array(
                        'name'=>array('header','header_style_5','topbar_bottom_border_dark','opacity')
                    ));
                ?>
            </div>
        </div>
